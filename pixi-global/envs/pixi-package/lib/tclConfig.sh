...
TCL_CC='/home/conda/feedstock_root/build_artifacts/tk_1763054540972/_build_env/bin/x86_64-conda-linux-gnu-cc'
...
# installed.
TCL_PREFIX='pixi-global/envs/pixi-package'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='pixi-global/envs/pixi-package'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem pixi-global/envs/pixi-package/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/tk_1763054540972/work=/usr/local/src/conda/tk-8.6.13 -fdebug-prefix-map=pixi-global/envs/pixi-package=/usr/local/src/conda-prefix -pipe -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem pixi-global/envs/pixi-package/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,--allow-shlib-undefined -Wl,-rpath,pixi-global/envs/pixi-package/lib -Wl,-rpath-link,pixi-global/envs/pixi-package/lib -Lpixi-global/envs/pixi-package/lib -Wl,--export-dynamic '
...
TCL_RANLIB='/home/conda/feedstock_root/build_artifacts/tk_1763054540972/_build_env/bin/x86_64-conda-linux-gnu-ranlib'
...
# build directory.
TCL_BUILD_LIB_SPEC='-Lpixi-global/envs/pixi-package/lib -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-Lpixi-global/envs/pixi-package/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-Ipixi-global/envs/pixi-package/include'
...
# compiled.
TCL_SRC_DIR='pixi-global/envs/pixi-package/include'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='{pixi-global/envs/pixi-package/lib} '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-Lpixi-global/envs/pixi-package/lib -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Lpixi-global/envs/pixi-package/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='pixi-global/envs/pixi-package/lib/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='pixi-global/envs/pixi-package/lib/libtclstub8.6.a'
